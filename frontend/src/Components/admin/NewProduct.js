...
function NewProduct() {
    ...
    const submitHandler = (e) => {
        ...
        formdData.append('price', price);
        formdData.append('stock', stock);
        formdData.append('description', description);
        formdData.append('seller', seller);
        formdData.append('category', category);
        images.forEach(image => {
            formdData.append('images', image)
        })
        dispatch(createNewProduct(formdData))
    ...
    useEffect(() => {
        if(isProductCreated) {
            toast('Product Createde successfully', {
                type:'success',
